...
package AVTAS.LMCP.Types is
   ...
   type UInt16 is new Interfaces.Unsigned_16 with Annotate => (GNATProve, No_Wrap_Around);
   type UInt32 is new Interfaces.Unsigned_32 with Annotate => (GNATProve, No_Wrap_Around);
   type UInt64 is new Interfaces.Unsigned_64 with Annotate => (GNATProve, No_Wrap_Around);
